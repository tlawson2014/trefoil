...
func (am AppModule) EndBlock(ctx context.Context) error {
	// Every block, the recovery module checks whether any pending recovery
	// has finished its waiting period (and executes it) or has expired
	// unapproved (and drops it). See keeper/abci.go.
